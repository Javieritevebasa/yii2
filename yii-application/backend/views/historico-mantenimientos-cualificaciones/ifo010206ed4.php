...
<div class="historico-mantenimientos-cualificaciones-index">
    ...
    <table class="table  table-bordered table-condensed table-fixedHeader" >
		...
		<tr>
			<th colspan="3"></th>
    		<th colspan="<?=count($cualificaciones)?>" class="text-center">PLAN DE SUPERVISIONES IN SITU A INSPECTORES<span class="pull-right">Impreso IFO-01-02-06 Ed.4</span></th>
    	</tr>
    	<tr>
    		<th colspan="3"></th>
    	...
    	<tr>
    		...
    		<th colspan="2" class="text-center">OTRAS ACTUACIONES</th>
    	</tr>    		
    	<tr>
