...
<div class="historico-mantenimientos-cualificaciones-index container-fluid">
    ...
    <table class="table table-condensed table-bordered table-fixedHeader" >
    	<thead>
	    	<tr>
	    		<th colspan="2"></th>
	    		<th colspan="<?=count($cualificaciones)?>" class="text-center">LISTADO DE RESPONSABLES TÉCNICOS CUALIFICADOS<span class="pull-right">Impreso IFO-01-02-09 Ed.0</span></th>
	    	</tr>
	    	<tr>
	    		<th colspan="2"></th>
