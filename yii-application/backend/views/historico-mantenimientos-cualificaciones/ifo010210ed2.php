...
<div class="historico-mantenimientos-cualificaciones-index">
    ...
    <table class="table  table-bordered table-condensed table-fixedHeader" >
		...
		<tr>
			<th colspan="2"></th>
    		<th colspan="<?=count($cualificaciones)?>" class="text-center">PLAN DE SUPERVISIONES IN SITU A RESPONSABLES TÉCNICOS<span class="pull-right">Impreso IFO-01-02-10 Ed.2</span></th>
    	</tr>
    	<tr>
    		<th colspan="2"></th>
