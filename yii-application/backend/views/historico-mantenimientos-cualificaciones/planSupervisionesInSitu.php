...
$this->title = 'Plan Supervisiones in situ';
...
<div class="historico-mantenimientos-cualificaciones-index">
    ...
    <table class="table  table-bordered table-condensed table-fixedHeader" >
		...
		<tr>
			<th colspan="4"></th>
    		<th colspan="<?=count($cualificaciones)?>" class="text-center">PLAN DE SUPERVISIONES<span class="pull-right">Impreso IFO-01-02-06 Ed.2</span></th>
    	</tr>
    	<tr>
    		<th colspan="4"></th>
    	...
    	<tr>
    		...
    		<?php foreach ($cualificaciones as $key => $cualificacion) : ?>
				<th width='<?= 85/count($cualificaciones)?>%'><?= $cualificacion->nombre; ?></th>
		...
		<tr>
			<td colspan="17" style="text-align:left !important;">
				...
				<ul>
					...
					<li><span style= "width:30px; height:15px; display: inline-block" class="proximoCaducar"></span>&nbsp;< 1 año</li>
