...
?>
<tr>
	<td><button class="btn btn-default btn-xs" type="button" data-toggle="collapse" data-target="#collapseHistorico<?= $model->idGrupoCategorias ?>" aria-expanded="false" aria-controls="collapseHistorico<?= $model->idGrupoCategorias ?>"><span class="glyphicon glyphicon-collapse-down"></span></button></td>
	<td><?= Html::encode($model->grupoCategorias->cualificacion->nombre) ?></td>
...
<tr class="collapse"  id="collapseHistorico<?= $model->idGrupoCategorias ?>">
